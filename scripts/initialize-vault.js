...
const CONVEX_AUTHORITY = new web3.PublicKey("CNhWD1cXNaCMcjJmFcK25aFgV3ZTAFtyFDBvGfKZcpzF");
...
async function main() {
  ...
  const idl = JSON.parse(fs.readFileSync(path.join(__dirname, "../target/idl/space_vault_program.json"), "utf8"));
