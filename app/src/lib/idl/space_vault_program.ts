...
export type SpaceVaultProgram = {
  ...
  instructions: [
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: "const";
                value: [99, 108, 97, 105, 109, 45, 114, 101, 99, 111, 114, 100];
              },
              {
                kind: "arg";
                path: "claimId";
    ...
    {
      name: "crankLiquidity";
      discriminator: [1, 222, 14, 191, 61, 205, 81, 198];
      accounts: [
        {
          name: "cranker";
          writable: true;
    ...
    {
      name: "gamePayment";
      discriminator: [44, 5, 226, 247, 176, 177, 31, 183];
      accounts: [
        {
          name: "player";
          writable: true;
    ...
    {
      name: "setMeteoraPool";
      discriminator: [98, 249, 21, 7, 173, 94, 135, 74];
      accounts: [
        {
          name: "authority";
          signer: true;
