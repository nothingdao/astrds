...
const readCanvasTokens = (): CanvasTokens => ({
  ...
  backgroundAlpha: readCssVar(VARS.backgroundAlpha, FALLBACK_TOKENS.backgroundAlpha),
  ...
  asteroidStroke: readCssVar(VARS.asteroidStroke, FALLBACK_TOKENS.asteroidStroke),
  ...
  shipPickupFill: readCssVar(VARS.shipPickupFill, FALLBACK_TOKENS.shipPickupFill),
  shipPickupStroke: readCssVar(VARS.shipPickupStroke, FALLBACK_TOKENS.shipPickupStroke),
  shipPickupInner: readCssVar(VARS.shipPickupInner, FALLBACK_TOKENS.shipPickupInner),
  shieldPowerup: readCssVar(VARS.shieldPowerup, FALLBACK_TOKENS.shieldPowerup),
  rapidFirePowerup: readCssVar(VARS.rapidFirePowerup, FALLBACK_TOKENS.rapidFirePowerup),
