...
export const isNativeSolMint = (mintAddress?: string | null) => mintAddress === NATIVE_SOL_MINT

export const formatTokenAmount = (rawAmount: number, decimals: number, maximumFractionDigits = decimals) =>
